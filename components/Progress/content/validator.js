...
export const pilihKategori = (value) => (!value ? "Pilih Jenis Kategori" : "");
export const pilihStatus = (value) => (!value ? "Pilih Jenis Status" : "");
export const pilihLokasi = (value) => (!value ? "Pilih Lokasi Perawatan" : "");
export const formInput = (value) => (!value ? "Field Harus Terisi" : "");

export const termsValidator = (value) => (value ? "" : "It's required to agree with Terms and Conditions.");
export const emailValidator = (value) => (!value ? "Email field is required." : emailRegex.test(value) ? "" : "Email is not valid format.");
...
export const userNameValidator = (value) => (!value ? "User Name is required" : value.length < 5 ? "User name should be at least 3 characters long." : "");
